        ...
        <div class="container mt-4">
            <div class="row justify-content-center">
                ...
                <?php 
                        for($i = 0; $i<29; $i++){
                            ?>
                <div class="col-auto m-3 card bg-primary" style="height: 300px; width: 300px;">
                    <div class="row">
                        <div class="col-7">
                            <div class="row">
                                <div style="margin-top: 10px; margin-left: 15px">
                                    <svg width="150px" height="55px">
                                        <polygon points="10,30 30,10 140,10 140,50 30,50"
                                            style="fill: transparent; stroke:white;stroke-width:3; stroke-linejoin: round" />
                                ...
                                <div class="=col-auto">
                                    <div style="margin-top: 5px">
                                        <i class="fas fa-map-marker-alt"
                                            style="color: white; height: 30px; width: 30px; margin: 8px 10px 10px 20px"></i>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <div style="margin-top: 5px">
                                        <span style="color: white">Mosbach</span>
                                        <br>
                                        <span style="color: white">15 km</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div style="height: 100px; overflow: hidden; margin-top: 30px">
                                <h5 style="color: white">Ein Joghurt</h5>
                                <p style="color: white">Habe einen Naturjoghurt übrig. Will den jemand?<br>Dritte
                                    Textzeile</p>
                            </div>
                        </div>
                    </div>
