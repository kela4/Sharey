    ...
    <div class="content mt-4">
        ...
        <div class="container">
            ...
            <p> Auf dieser Plattform kannst du dazu beitragen, die Verschwendung von Ressourcen auf unserer Erde
                zu reduzieren. Hier erklären wir dir Schritt für Schritt, wie du ein Angebot anlegen kannst und
                es übergibst.
            </p>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-10 align-self-center">
                    ...
                    <p>
                        Um ein Angebot anzulegen, begibt dich auf unsere Startseite. Dort klickst du auf den runden "+"
                        Button in der
                        unteren
                        Bildschirmmitte.
                    </p>
                    ...
                    <p> Falls du noch nicht eingeloggt bist, erhältst du nun die Möglichkeit, dich zu registrieren oder
                        einzuloggen.
                        Zur Registrierung benötigst du nur eine Email Adresse und ein sicheres Passwort. Wir benötigen
                        keinen Nanen oder weitere persönliche Angaben von dir. Datenschutz ist uns wichtig!
                    </p>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-10 align-self-center">
                    ...
                    <p>
                        Ein Bild sagt mehr als tausend Worte. Deshalb geben wir dir auch die Möglichkeit dein Angebot
                        mit
            ...
            <div class="row">
                <div class="col-12 col-md-2 text-center align-self-center">
                    <img src="images/4.png" class="img-fluid rounded" alt="4" />
                </div>
            ...
            <div class="row">
                <div class="col-12 col-md-2 text-center align-self-center">
                    <img src="images/5.png" class="img-fluid rounded" alt="5" />
                </div>

                <div class="col-12 col-md-10 align-self-center">

                    <p>
                        Um Einzelheiten, den Übergabeort und die Zeit zu klären, könnt ihr beide euch nun Nachrichten
                        schreiben.
                        Wir arbeiten ohne Benutzernamen, das heißt, die User werden nach der Reihenfolge in der sie
                        angefragt haben, angezeigt.
                    </p>

                    <p>
                        Bitte seid immer freundlich zu einander! Wenn du nicht deine private Wohnadresse für den
                        Austausch nennen möchtest, trefft euch doch einfach an einem öffentlichen Ort.
                        Sharey soll eine Plattform zum Teilen sein, deshalb werden für die Angebote keine
                        Gegenleistungen oder Bezahlungen erwartet.
                    </p>
            ...
            <div class="row">
                <div class="col-12 col-md-2 text-center align-self-center">
                    <img src="images/6.png" class="img-fluid rounded" alt="6" />
                </div>

                <div class="col-12 col-md-10 align-self-center">

                    <p>
                        Nachdem dein Produkt erfolgreich bei seinem neuen Besitzer ist, kannst du die Übergabe in der
                        entsprechenden Konversation
                        mit "Angebot angenommen" markieren.
                    </p>

                    <p>
                        Dadurch wird das Angebot beendet und alle weiteren User, die mit dir zu diesem Angebot eine
                        Konversation gestartet haben,
                        bekomme eine automatische Nachricht.
                    </p>
            ...
            <div class="row">
                <div class="col-12 col-md-2 text-center align-self-center">
                    <img src="images/!.png" class="img-fluid rounded" alt="!" />
                </div>

                <div class="col-12 col-md-10 align-self-center">

                    <p>
                        Sollte einmal etwas nicht so laufen, wie du es dir vorstellst, kannst du jede Konversation
                        jederzeit beenden.
